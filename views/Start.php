...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://users.du.se/~h09idafu/IK1005/Style/Style_Start.css">
...
<div id="content">
    ...
    <main>
        ...
        <!--Bild leende och text-->
        <div class="bildOchText">

            <div class="leende">
                <img src="http://users.du.se/~h09idafu/IK1005/bilder_NordicTree/tomte.jpg" alt="Glad tomte">
            </div>

            <!--Informationsruta-->
            <div class="info">

                <h1>NordicTree kravodlade granar</h1>
                <br>

                <p class="text1">
Vi erbjuder ett stort utbud av granar, kungsgranar, tallar, plastgranar samt tillbehör till dessa.
Vi på NordicTree värnar om våran miljö. Därför är alla våra granar och tallar kravodlade och krav-märkta.
                </p>
                <br>
                <p class="text2">
Vi känner stort ansvar för vårat miljöarbete, därför lägger vi ner mycket tid och resurser för att
                    kunna utföra vårat arbete så förnyelsebart som möjligt.
                </p>
                <br>
                <p class="text3">
Vi använder alltid minst Euro6 lastbilar för transport, och Rudolf själv kör givetvis Tesla.
Vi strävar mot att bli -Årets miljö och energi företag 2017.
</p>
        ...
        <h2 class="best">Bästsäljare</h2>
        <br>

        <!--Bästsäljare-->
        <div class="bilder">

            <div class="bastsaljare1" tabindex="8">
                <a href="http://users.du.se/~h09idafu/IK1005/NordicTreePHP/index1.php/ProductController/getProductByID/10">
                    <img src="http://users.du.se/~h09idafu/IK1005/bilder_NordicTree/gran_mini1.jpg" alt="Gran mini mini">
                </a>
            </div>

            <div class="bastsaljare2" tabindex="9">
                <a href="http://users.du.se/~h09idafu/IK1005/NordicTreePHP/index1.php/ProductController/getProductByID/13">
                    <img src="http://users.du.se/~h09idafu/IK1005/bilder_NordicTree/tall_medium1.jpg" alt="Tall medium">
                </a>
            </div>

            <div class="bastsaljare3" tabindex="10">
                <a href="http://users.du.se/~h09idafu/IK1005/NordicTreePHP/index1.php/ProductController/getProductByID/21">
                    <img src="http://users.du.se/~h09idafu/IK1005/bilder_NordicTree/plastgran_gron.jpg" alt="Plastgran grön">
                </a>
            </div>
